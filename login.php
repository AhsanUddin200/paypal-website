...
if (isset($_POST['login'])) {
    ...
    $sql = "SELECT * FROM paypal_user WHERE email='$email'";
...
<body>
    <div class="login-container">
        ...
        <div class="link">
            <a href="signup.php" style="color: #005fa3; background-color: #f1f1f1; padding: 10px 20px; border-radius: 5px; display: inline-block; text-decoration: none;">Sign Up</a>
        </div>
    </div>
</body>
</html>
